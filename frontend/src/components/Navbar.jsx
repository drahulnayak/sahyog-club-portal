...
// --- 1. Import your new home emoji icon ---
// This path assumes Navbar.jsx is in 'src/components' and the image is in 'src/assets'
  ...
  return (
    <nav className="navbar">
      ...
      <Link to="/" className="navbar-brand">
        ...
        {/* --- 2. Add your icon image tag AFTER the text --- */}
        <img 
          src={homeIcon} 
          alt="Home Icon"
          style={{ 
            height: '22px', // You can adjust this size
            width: '22px', 
            marginLeft: '8px', // Adds a small space
